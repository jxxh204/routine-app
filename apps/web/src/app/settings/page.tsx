  ...
  return (
    ...
    <PageShell>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <Link href="/today" style={{ color: 'var(--accent)', textDecoration: 'none', marginTop: 8 }}>
          오늘으로
        </Link>
      </div>
      ...
      <AppCard>
        ...
        <p style={{ margin: '8px 0', color: 'var(--text-muted)' }}>현재 웹 알림 권한: {permissionLabel(permission)}</p>
      ...
      <AppCard>
        ...
        <p style={{ margin: '8px 0 0', color: 'var(--text-muted)' }}>iOS WebView 환경에서는 시스템 설정에서 알림 권한을 최종 확인해 주세요.</p>
      </AppCard>
    </PageShell>
    </AuthRequired>
  );
